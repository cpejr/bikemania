...
/* POST Mirante route */
router.post("/dashboardMirante", auth.isAuthenticated, function (req, res) {
...
/* POST Contagem route */
router.post("/dashboardContagem", auth.isAuthenticated, function (req, res) {
...
/* GET dailyBalance */
router.get("/dailyBalance", auth.isAuthenticated, auth.isMaster, function (req, res) {
  var months = [
    "January",
    "February",
    "March",
...
router.get("/dailyBalance/next", auth.isAuthenticated, auth.isMaster, function (req, res) {
  var months = [
    "January",
    "February",
    "March",
...
/* GET daily Report */
router.get("/dailyReport", auth.isAuthenticated, auth.isMaster, function (req, res) {
...
router.post("/dailyReport", auth.isAuthenticated, auth.isMaster, function (req, res) {
...
/* GET dailyBalance */
router.get("/monthlyBalance", auth.isAuthenticated, auth.isMaster, function (req, res) {
  var months = [
    "January",
    "February",
    "March",
...
router.get("/equipamentBalance", auth.isAuthenticated, auth.isMaster, function (req, res, ) {
  var months = [
    "January",
    "February",
    "March",
