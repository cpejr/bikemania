  ...
  (function($) {
    AddTableRow = function() {
      ...
      cols += '<td>&nbsp;<div class="col-lg-4"><div class="cadastro mt-1"><div class="texto-centro"><input type="number" class="form-control" name="rent[quantity]" min="1" required = "required"></div></div></div></td>';
      cols += '<td><div class="col-lg-8"><div class="cadastro mt-4"><div class="texto-centro"><button onclick="remove(this)" type="button">Remover</button></div></div></div></td>';
